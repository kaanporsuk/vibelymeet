...
test("video bubbles remain adaptive and full-width across web and native chat", () => {
  ...
  assert.doesNotMatch(webVibeClipBubble, /\[meta\.processingStatus, meta\.thumbnailUrl, meta\.videoUrl, sparkMessageId\]/);
  ...
  assert.match(nativeVibeClipCard, /metaThumbnailUrlRef/);
...
test("server upload and publish paths enforce Bunny Stream Vibe Clip limits", () => {
  ...
  assert.match(webChat, /thumbnailSourceRef: effectiveThumbnailSourceRef/);
  assert.match(webChatMediaResolver, /await getCachedMediaAsset\(row\.id, "thumbnail", thumbnailRef/);
  assert.match(webChatMediaResolver, /displayPayload\.thumbnail_url = thumbnailUrl/);
  ...
  assert.match(nativeChatMediaResolver, /await getCachedMediaAsset\(row\.id, 'thumbnail', thumbnailRef/);
  assert.match(nativeChatMediaResolver, /displayPayload\.thumbnail_url = thumbnailUrl/);
