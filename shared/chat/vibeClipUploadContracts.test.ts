...
test("video bubbles remain adaptive and full-width across web and native chat", () => {
  ...
  assert.match(webVibeClipBubble, /if \(reason === "preview"\) return !!displayableFreshThumbnailUrl/);
  ...
  assert.match(nativeVibeClipCard, /if \(reason === 'preview'\) return !!displayableFreshThumbnailUri/);
