...
test("video bubbles remain adaptive and full-width across web and native chat", () => {
  ...
  assert.match(webApp, /selectPrimaryRecoveryAttentionTarget\(recoveryAttentionTargets, currentOtherUserId\)/);
  assert.match(webApp, /uploadAttention: primaryTarget\.attentionId/);
  assert.match(webApp, /uploadAttentionNonce: String\(Date\.now\(\)\)/);
  assert.match(webApp, /setHiddenAttentionKey\(""\)/);
  ...
  assert.match(nativeLayout, /selectPrimaryRecoveryAttentionTarget\(recoveryAttentionTargets, currentOtherUserId\)/);
  ...
  assert.match(nativeLayout, /setHiddenAttentionKey\(''\)/);
