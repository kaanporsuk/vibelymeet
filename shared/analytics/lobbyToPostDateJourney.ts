...
export const LobbyPostDateEvents = {
  ...
  VIDEO_DATE_ROOM_WARMUP_STARTED: 'video_date_room_warmup_started',
  VIDEO_DATE_ROOM_WARMUP_SUCCESS: 'video_date_room_warmup_success',
  VIDEO_DATE_ROOM_WARMUP_FAILURE: 'video_date_room_warmup_failure',
