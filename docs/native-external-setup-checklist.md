...
**Closure gate:** Use **`docs/native-external-setup-closure.md`** to turn this provider setup into a final repo-vs-dashboard go/no-go checklist before TestFlight / Play internal distribution.
