...
| **Match celebration** | Yes (MatchCelebration page + post-date survey / modals) | Yes | No screen | Yes — minimal screen + wire from matches (unread → celebration → chat) | **Implement now** |
