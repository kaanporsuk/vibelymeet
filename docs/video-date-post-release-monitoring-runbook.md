...
Current 2026-06-06 recovery baseline:
...
- Confirm web/native/mobile clients in the monitored environment send `mark_video_date_daily_alive` heartbeats after `20260606180000_video_date_stable_copresence_handshake_guard.sql`.
