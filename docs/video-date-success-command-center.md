...
- Rollout boundary: this migration is intentionally dry-run validated but not pushed to cloud yet. Applying it before web/native/mobile clients that call `mark_video_date_daily_alive` are deployed can make older clients wait indefinitely after `mark_video_date_daily_joined` returns `waiting_for_stable_copresence`. Current linked Supabase state remains aligned through `20260606164737_event_registration_rpc_owned_dml_lockdown.sql`; dry-run reports exactly one pending migration: `20260606180000_video_date_stable_copresence_handshake_guard.sql`.
...
Current recovery work builds on PR #1204 merge commit `6c7c24e1d`, follow-up commit `9fc82b5f9867de0ab9905e64804c3d226a0f065f`, PR #1200 merge commit `fbca4996a096273914ee650b556ba7994477aa5e`, PR #1199 merge commit `ebe4690467b7956511338d94c5847b88889cd1a8`, PR #1196 recovery hardening commit `359fa5c42bd5fcdefef9a8a1fca9396d96194f4f`, and PR #1194 squash commit `0a160cd975d87cd756e9c399e748810508f005cb`. Supabase project `schdyxcunwcvddlcshwd` has migrations 20260604142017, 20260604170438, 20260604193140, 20260604205645, 20260605085010, 20260605115657, 20260605135616, 20260605143637, 20260605144003, 20260605145306, 20260605145926, 20260605150130, 20260605152058, 20260605170249, 20260605174703, 20260605200729, 20260605203904, 20260605211924, 20260605221535, 20260605222458, 20260605232304, and 20260606164737 applied as of the 2026-06-06 event-registration RPC-owned DML lockdown. New migration `20260606180000_video_date_stable_copresence_handshake_guard.sql` is local and dry-run validated but intentionally not applied yet; it must be deployed only in coordination with web/native/mobile clients that send `mark_video_date_daily_alive` heartbeats. `video-date-outbox-drainer`, `video-date-room-cleanup`, and `video-date-orphan-room-cleanup` were redeployed to preserve terminal room metadata and stamp provider-delete markers. Verify current Git main/origin-main, `supabase migration list --linked`, `supabase db push --linked --dry-run`, and live function/catalog markers before assuming state. send-notification version 813 was deployed on 2026-06-05 01:59:45 UTC.
