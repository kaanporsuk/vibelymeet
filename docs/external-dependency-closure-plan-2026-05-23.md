...
| Edge Function source/config parity | closed | 2026-05-26 repo refresh: 71 deployable source functions and 71 `supabase/config.toml` entries. The 2026-05-23 cloud snapshot covered then-active deployed functions; re-confirm cloud deployment after any function source/config change. | Keep manifest and inventory aligned to the current config-backed count. |
