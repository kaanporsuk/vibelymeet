...
| **Video Date Handshake/active-presence release: timer starts after active latest Daily co-presence** | `docs/vibely-canonical-project-reference.md` §4.1 and `docs/video-date-success-command-center.md`; migrations `20260501170000_video_date_handshake_starts_after_daily_join.sql` and `20260604142017_video_date_active_presence_join_guard.sql`; Edge Function `daily-room` |
