...
- Survey-required terminal truth makes `/date/:sessionId` the survey host and should hard-stop Daily start/retry, surface claim, reconnect, and peer-missing loops. Generic `session_ended` is terminal-stop truth only; survey recovery requires `queue_status = 'in_survey'`, `survey_required`, or `surveyRequired`.
...
- `mark_video_date_daily_alive`, `mark_video_date_daily_joined`, `video_date_transition`, `get_video_date_queue_hint_v1`, `drain_match_queue_v2`, and `claim_video_date_surface` should fail soft with structured retryable JSON under stale/duplicate/terminal churn. Raw SQL diagnostics belong in service-side observability; authenticated web/native/mobile client payloads must be sanitized, and shared client classifiers must separate terminal-stop truth from terminal-survey truth.
...
- Current active recovery migrations are applied/aligned through provider-bound remote-seen lint cleanup migration `20260608122623_video_date_remote_seen_lint_cleanup.sql`, including `20260606180000_video_date_stable_copresence_handshake_guard.sql`, `20260606203000_video_date_provider_authoritative_presence.sql`, `20260606205211_video_date_provider_participant_id_presence_repair.sql`, `20260606224200_video_date_provider_terminal_recovery.sql`, `20260607103000_video_date_mutual_match_handoff_closure.sql`, `20260607103100_video_date_provider_joined_absence_terminal.sql`, `20260607123952_video_date_routeable_both_ready_entry_protection.sql`, `20260607152000_video_session_created_definitive_contracts.sql`, `20260607155414_video_date_lifecycle_rpc_terminal_contracts.sql`, `20260607183000_video_date_ready_gate_entry_proof.sql`, `20260607183100_video_date_lifecycle_truthy_helper_alignment.sql`, `20260607194546_video_date_definitive_provider_overlap_promotion.sql`, `20260607205617_video_date_provider_overlap_current_remote_seen.sql`, `20260607222923_video_date_daily_owner_definitive_recovery.sql`, `20260608001000_video_date_base_failsoft_payload_sanitization.sql`, `20260608080938_video_date_lifecycle_rpc_last_resort_failsoft.sql`, `20260608114500_review_comments_1232_1242_followups.sql`, `20260608114600_review_comments_identifier_hygiene.sql`, `20260608120000_video_date_provider_bound_remote_seen.sql`, `20260608121834_video_date_remote_seen_identifier_hygiene.sql`, and `20260608122623_video_date_remote_seen_lint_cleanup.sql`.
- PR #1245 merged the provider-bound remote-seen recovery as `a178e1265001f01d5beca0375c38a9cb8c0d4e59`; its branch was deleted, GitHub checks passed, Vercel reported success, and the parent workspace recorded gitlink commit `7d1443e5a2d6dd93c3bc6df6a0a1810b102c1bc8` with `Git/vibelymeet` pointing to `a178e1265001f01d5beca0375c38a9cb8c0d4e59`.
