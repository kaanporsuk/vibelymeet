...
- Current recovery migrations are applied through `20260606205211_video_date_provider_participant_id_presence_repair.sql`, including `20260606180000_video_date_stable_copresence_handshake_guard.sql`, `20260606203000_video_date_provider_authoritative_presence.sql`, and `20260606205211_video_date_provider_participant_id_presence_repair.sql`.
