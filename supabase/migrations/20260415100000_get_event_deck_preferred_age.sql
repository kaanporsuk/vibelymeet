-- Apply viewer preferred_age_min/max on event lobby deck (columns from 20260407180000).
-- Runs after 20260412120000_event_cancel_truth_capacity so this definition is final.
