-- Restore approved discover rule: rows visible until effective_end + 6 hours (supersedes 20260429103000 strict-end).
-- No data backfills — function body matches 20260418140000 get_visible_events definition.
