-- Stream 1B follow-up: production-safe auth guard for get_event_deck
-- This migration is additive and becomes the canonical definition for the live function.
