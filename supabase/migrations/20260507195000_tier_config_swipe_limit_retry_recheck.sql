-- Tier Config swipe limit retry recheck.
...
VALUES (
  ...
  'Tier Config swipe limit retry recheck',
  'schema+policy',
  'Re-checks actor-target swipe idempotency after acquiring the daily swipe limit advisory lock, so concurrent duplicate retries keep returning base idempotent outcomes instead of being masked by finite quota enforcement.',
  false
)
