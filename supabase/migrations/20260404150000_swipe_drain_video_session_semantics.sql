-- Dual keys for session-stage flows: `video_session_id` + `event_id` alongside legacy `match_id`
-- (`match_id` remains video_sessions.id until clients migrate — not matches.id).
