-- Follow-up to PR review comments on the schedule-share accept/edit RPC.
--
-- Replay-safe: pure CREATE OR REPLACE FUNCTION.
-- Non-destructive: preserves the existing v2 action surface while tightening
-- input validation and active-grant authorization.
