-- Keep the authoritative post-date router aligned with the standalone Ready
-- Gate surface. Older migrations routed by action correctly but still returned
-- an obsolete lobby route label for telemetry.
