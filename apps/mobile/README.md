...
- **Sprint 5:** Live video date: join Daily.co room via `daily-room` (`prepare_date_entry`), `video_date_transition` (enter_handshake, end), local/remote video, end/leave with `delete_room` + backend end. See `docs/mobile-sprint5.md`.
