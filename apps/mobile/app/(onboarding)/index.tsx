...
const styles = StyleSheet.create({
  ...
  welcomeSub: { fontSize: 16, textAlign: 'center' as const, lineHeight: 24, paddingHorizontal: 16 },
  welcomeBullets: {
    width: '100%' as const,
    borderTopWidth: 1,
    paddingTop: 20,
  ...
  welcomeBullet: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 12 },
  bulletIcon: {
    width: 44,
    height: 44,
    borderRadius: 22,
