...
const styles = StyleSheet.create({
  ...
  eventCardMedia: { height: 176, position: 'relative' },
  ...
  eventCardBody: { padding: spacing.lg, paddingTop: spacing.md, gap: spacing.md },
  ctaWrap: { width: '100%' },
  ...
  discoverImage: { width: '100%', height: 116 },
  discoverBody: { padding: spacing.md + 2, gap: 4 },
