...
export default function GenderStep({ value, customValue, onChange, onChangeCustom, showOnProfile, onToggleShow, onNext }: { value: string; customValue: string; onChange: (v: string) => void; onChangeCustom: (v: string) => void; showOnProfile: boolean; onToggleShow: (v: boolean) => void; onNext: () => void; }) {
...
const styles = StyleSheet.create({ root: { gap: 10 }, h1: { fontSize: 30, fontWeight: '700', marginBottom: 4 }, opt: { borderWidth: 1, borderRadius: 14, minHeight: 48, justifyContent: 'center', paddingHorizontal: 12 }, input: { borderWidth: 1, borderRadius: 14, minHeight: 48, paddingHorizontal: 12 }, toggle: { marginVertical: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' } });
