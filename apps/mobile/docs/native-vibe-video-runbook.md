...
| `delete-vibe-video` | **200** + `{ success: true, hadVideoToDelete, dbProfileCleared, bunnyRemoteDeleteOk: null, bunnyRemoteDeleteHttpStatus: null, possibleBunnyOrphan: false, deleteDeferredToWorker: true }` | **401**, **500** with `{ success: false, error, code? }` |
