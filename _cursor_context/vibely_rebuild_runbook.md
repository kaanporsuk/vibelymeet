...
- all 71 Edge Functions are deployed when doing a full rebuild
- JWT behavior matches config (40 JWT-at-gateway, 31 public-but-protected); required secrets set
...
- All 71 current deployable functions are in config.toml; no source/config gaps.
