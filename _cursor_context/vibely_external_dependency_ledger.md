...
- all 70 deployable functions are in `supabase/config.toml`; 40 JWT-at-gateway, 30 public-but-protected
...
- confirm all 70 Edge Functions are deployed with correct verify_jwt
