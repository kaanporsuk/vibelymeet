...
- all 54 deployable functions are in `supabase/config.toml`; 34 JWT-at-gateway, 20 public-but-protected
...
- confirm all 54 Edge Functions are deployed with correct verify_jwt
