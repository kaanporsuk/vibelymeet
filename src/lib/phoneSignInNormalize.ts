/**
 * E.164 normalization for web phone sign-in (Supabase signInWithOtp).
 * Mirrors apps/mobile/lib/phoneSignInNormalize.ts — pure functions, no native deps.
 */
...
/**
 * Same practical bounds as native PhoneVerificationFlow.
 */
