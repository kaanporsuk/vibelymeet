        ...
        <div className="space-y-4 py-4">
          <div className="flex items-start gap-3 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
            ...
            <p className="text-sm text-muted-foreground">
              Blocking is permanent and cannot be undone from the app. Use{" "}
              <span className="font-medium text-foreground">Settings → Support & Feedback</span> to request help if you
              need to unblock someone.
            </p>
          </div>
