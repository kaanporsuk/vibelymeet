    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="pointer-events-none absolute bottom-full left-4 right-4 mb-2"
        >
          <div className="pointer-events-auto glass-card rounded-2xl p-3 border border-primary/30 flex items-center justify-between gap-3">
