...
const actionPresentations: Record<string, ActionPresentation> = {
  ...
  "event.publish": { label: "Event Published", icon: Send, className: toneClasses.positive },
  "event.unpublish": { label: "Event Unpublished", icon: EyeOff, className: toneClasses.warning },
  ...
  "event.publish_series": { label: "Event Series Published", icon: Send, className: toneClasses.positive },
  "event.unpublish_series": { label: "Event Series Unpublished", icon: EyeOff, className: toneClasses.warning },
...
const actionFilterOptions: SelectOption[] = [
  ...
  { value: "event.publish_series", label: "Event Series Published" },
  { value: "event.unpublish_series", label: "Event Series Unpublished" },
